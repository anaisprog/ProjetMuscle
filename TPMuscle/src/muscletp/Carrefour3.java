...
public class Carrefour3 extends Carrefour {
	
	SegmentRoute sNord;
	SegmentRoute sSud ;
	SegmentRoute sEst;
	
	public Carrefour3(SegmentRoute s1, SegmentRoute s2, SegmentRoute s3)
	{
		super();
		this.sNord = s1 ;
		this.sSud = s2 ;
		this.sEst = s3 ;
		this.type = "Carrefour3";
		
	}
	
	public Carrefour3(SegmentRoute s1, SegmentRoute s2, SegmentRoute s3, int id)
	{
		super(id);
		this.sNord = s1 ;
		this.sSud = s2 ;
